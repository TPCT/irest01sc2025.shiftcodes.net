                ...
                if ($this->upload->do_upload('userfile')) {
                    ...
                    if ($totalrows > 2 && $totalrows < 54) {
                        ...
                        for ($i = 4; $i <= $totalrows; $i++) {
                            $ingredint_name = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(0, $i)->getValue()));
                            $ingredint_code = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(1, $i)->getValue())); //Excel Column 1
                            $ingredint_category = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(2, $i)->getValue())); //Excel Column 2
                            $ingredint_purchase_unit = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(3, $i)->getValue())); //Excel Column 3
                            $ingredint_unit = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(4, $i)->getValue())); //Excel Column 3
                            $conversion_rate = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(5, $i)->getValue())); //Excel Column 3
                            $ingredint_perchaseprice = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(6, $i)->getValue())); //Excel Column 5
                            $ingredint_alertqty = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(7, $i)->getValue())); //Excel Column 4
