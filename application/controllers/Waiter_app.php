...
class Waiter_app extends Cl_Controller {
    ...
    public function add_sale_by_ajax(){
        ...
        $data['total_items'] = $order_details->total_items_in_cart;
        $data['sub_total'] = $order_details->sub_total;
        $data['charge_type'] = $order_details->charge_type;
        $data['vat'] = $order_details->total_vat;
        $data['total_payable'] = $order_details->total_payable;
        $data['total_item_discount_amount'] = $order_details->total_item_discount_amount;
        $data['sub_total_with_discount'] = $order_details->sub_total_with_discount;
        $data['sub_total_discount_amount'] = $order_details->sub_total_discount_amount;
        $data['total_discount_amount'] = $order_details->total_discount_amount;
        $data['delivery_charge'] = $order_details->delivery_charge;
        $data['sub_total_discount_value'] = $order_details->sub_total_discount_value;
        $data['sub_total_discount_type'] = $order_details->sub_total_discount_type;
        $data['user_id'] = $user_id;
        $data['waiter_id'] = $order_details->waiter_id;
        $data['outlet_id'] = $outlet_id;
        $data['sale_date'] = isset($order_details->open_invoice_date_hidden) && $order_details->open_invoice_date_hidden?$order_details->open_invoice_date_hidden:date('Y-m-d');
