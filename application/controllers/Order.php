...
class Order extends Cl_Controller {
    ...
    public function add_sale_by_ajax(){
        ...
        $data['total_items'] = $this->input->post('totalitem');
        $data['sub_total'] = $this->input->post('sub_total');
        $data['vat'] = $this->input->post('TotalTax');

        $data['total_payable'] = $this->input->post('totalVal');
        $data['total_item_discount_amount'] = 0;
        $data['sub_total_with_discount'] = $this->input->post('sub_total');
        $data['sub_total_discount_amount'] = 0;
        $data['total_discount_amount'] = 0;
        $data['delivery_charge'] = $this->input->post('totalCharge');
