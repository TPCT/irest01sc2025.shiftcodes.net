                ...
                if ($this->upload->do_upload('userfile')) {
                    ...
                    if ($totalrows > 2) {
                        ...
                        for ($i = 3; $i <= $totalrows; $i++) {
                            $menuOrIngredient = htmlspecialcharscustom($objWorksheet->getCellByColumnAndRow(0, $i)->getValue());
                        ...
                        if($totalFoodMenuToUpload<10){
                            for ($i = 3; $i <= $totalrows; $i++) {
                                $menuOrIngredient = htmlspecialcharscustom($objWorksheet->getCellByColumnAndRow(0, $i)->getValue());
                                $menuOrIngredientName = htmlspecialcharscustom($objWorksheet->getCellByColumnAndRow(1, $i)->getValue());
                                $consumption = null;
                                ...
                                if($menuOrIngredient=='FM'){
                                    ...
                                    $consumption = htmlspecialcharscustom($objWorksheet->getCellByColumnAndRow(2, $i)->getValue());
                                ...
                                $isNextMenuOrIngredient = htmlspecialcharscustom($objWorksheet->getCellByColumnAndRow(0, $i+1)->getValue());
