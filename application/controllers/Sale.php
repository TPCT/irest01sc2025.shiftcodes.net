...
class Sale extends Cl_Controller {
    ...
    public function add_customer_by_ajax(){
        ...
        $data['name'] = trim(htmlspecialcharscustom($this->input->post($this->security->xss_clean('customer_name'))));
        $data['phone'] = trim(htmlspecialcharscustom($this->input->post($this->security->xss_clean('customer_phone'))));
        $data['default_discount'] = trim(htmlspecialcharscustom($this->input->post($this->security->xss_clean('customer_default_discount'))));
        ...
        $data['address'] = trim(preg_replace('/\s+/', ' ',htmlspecialcharscustom($this->input->post($this->security->xss_clean('customer_delivery_address')))));
    ...
    public function online_customer_login_by_ajax(){
        $online_login_phone = trim(htmlspecialcharscustom($this->input->post($this->security->xss_clean('online_login_phone'))));
        $online_login_password = trim(htmlspecialcharscustom($this->input->post($this->security->xss_clean('online_login_password'))));
